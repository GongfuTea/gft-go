...
type GftAuthResourceRepo struct {
	*mgo.MgoTreeRepo[*auth.GftAuthResource]
}
...
func (repo GftAuthResourceRepo) All() ([]auth.GftAuthResource, error) {
	var results []auth.GftAuthResource
	var err error
